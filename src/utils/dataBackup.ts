  ...
  experience: [
    {
      ...
      StartYear: '2022',
      EndYear: '2024',
      Description: 'Provided exceptional customer service in an upscale dining environment. Managed high-volume service periods while maintaining quality standards. Collaborated with kitchen and service teams to ensure seamless operations.',
      Highlights: 'Handled customer relations and complaint resolution|Managed inventory and point-of-sale systems|Trained new staff members on service protocols',
      IsCurrent: false
    },
    {
      id: 2,
      ...
      StartYear: '2022',
      EndYear: '2022',
      Description: 'Seasonal position in alpine resort setting, serving international clientele. Developed cultural sensitivity and multilingual communication skills.',
      Highlights: 'Served diverse international customers|Adapted to high-pressure seasonal environment|Enhanced German language proficiency',
      IsCurrent: false
    },
    {
      id: 3,
      ...
      StartYear: '2019',
      EndYear: '2020',
      Description: 'Entry-level position developing foundational hospitality skills and customer service excellence in fast-paced environment.',
      Highlights: '',
      IsCurrent: false
    }
  ],
  education: [
    {
      ...
      StartYear: '2023',
      EndYear: 'Present',
      Description: 'Currently in second year of Bachelor\'s program focusing on software development, programming methodologies, and modern software architecture. Hands-on experience with various programming languages and development frameworks.',
      Highlights: 'Object-Oriented Programming|Web Development|Database Design|Software Architecture',
      IsCurrent: true
    },
    {
      id: 2,
      ...
      StartYear: '2020',
      EndYear: '2022',
      Description: 'Initial studies in business and creative industries before transitioning to technical focus. Developed foundational business acumen and project management skills.',
      Highlights: '',
      IsCurrent: false
    }
  ],
