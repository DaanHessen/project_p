...
const SocialMediaPanel = ({ currentPage, onArrowClick }: SocialMediaPanelProps) => {
  return (
    <div className="social-media-panel">
      ...
      <a 
        href="https://instagram.com/daanhessen" 
        target="_blank" 
        rel="noopener noreferrer" 
      ...
      >
        <svg viewBox="0 0 24 24" fill="currentColor">
          <path d="M18 6V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v2H5a1 1 0 0 0-1 1v11a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V7a1 1 0 0 0-1-1h-1zM8 4h8v2H8V4zm10 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8h12v10z"/>
          <path d="M21 9h-1v3a1 1 0 0 0 2 0V9z"/>
      ...
      <button 
        ...
        title={
          currentPage === 1 ? 'Explore Projects & Experience' : 
          currentPage === 2 ? 'Learn About Me' : 
          'Return to Homepage'
        }
      >
        <svg viewBox="0 0 24 24" fill="currentColor">
